...
{
    public class Capture_BodyTracking : MonoBehaviour
    {
        ...
        [Space]
        [SerializeField] private RenderTexture BodyTracking_RT;
        ...
        private void Update()
        {
            ...
            if (Stencil_Texture == null)Stencil_Texture = new Texture2D(1024, 1024);

            var currentRT = RenderTexture.active;
            RenderTexture.active = BodyTracking_RT;
        ...
        private async Task CaptureLoop(CancellationToken cancelToken)
        {
            ...
            while (!cancelToken.IsCancellationRequested)
            {
                ...
                using (Mat inpaintMat = new Mat())
                {
                    ...
                    Cv2.Flip(rgbMat, rgbMat, FlipMode.XY);
